    ...
    <div class="max-w-md mx-auto ">
        <div class="flex">
            <div class="w-full">
                <div class="mb-4">
                    <p>Usuarios Listos</p>
                    <div class="w-full flex flex-row  max-md:place-items-center">
                        <img src="./img/cheque.png" alt="" class="w-10 h-10 ">
                        <div :style="{ 'width': variable1 + '%' }" class="bg-gradient-to-r from-emerald-500 from-10% to-emerald-900 to-100% h-10  max-md:h-6 max-md:m-1"> </div>
                ...
                <div v-if="!evaluacionFin">
                    ...
                    <div class="w-full flex flex-row max-md:place-items-center">
                        ...
                        <div :style="{ 'width': variable2 + '%' }" class="bg-gradient-to-r from-pink-500 from-10%  to-red-500 to-90% h-10 max-md:h-6 max-md:m-1"></div>
                    </div>
